<template>
  <div v-if="Object.keys(book).length" class="flight m-3">
    <div class="row mt-3">
      <div class="col">
        <div>Altitude</div>
    ...
    <div class="row">
      <div class="col">
        ...
        <span
            :style="[fsuipc_status==='Connected' ? {'background-color': '#00800070'} : {'background-color': '#ff00007d'} ]">{{ fsuipc_status }}</span>
      </div>
      <div class="col">
