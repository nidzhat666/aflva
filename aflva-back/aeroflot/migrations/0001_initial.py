    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pilot', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='flight', to='aeroflot.pilot')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aircraft_image', models.ImageField(blank=True, upload_to='aeroflot/fleet_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aircraft_image', models.ImageField(blank=True, help_text='Image Size: 360x180', upload_to='aeroflot/aircraft_icao/')),
